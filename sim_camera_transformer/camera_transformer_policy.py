...
from sim_camera_transformer.adaptive_ensemble import AdaptiveEnsembler

class CameraTransformerInference:
    def __init__(
        self,
        saved_model_path: str = 'CameraTransformer/CameraTransformer-Base',
        ...
        self.vla = load_vla(
          saved_model_path,                       # choose from ['CameraTransformer/CameraTransformer-Small', 'CameraTransformer/CameraTransformer-Base', 'CameraTransformer/CameraTransformer-Large'] or the local path
