...
class CameraTransformerService:
    def __init__(
        self,
...
parser.add_argument("--saved_model_path", type=str, default="CameraTransformer/CameraTransformer-Base")
...
inferencer = CameraTransformerService(
