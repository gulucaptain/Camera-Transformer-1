...
# === CameraTransformer-VLA Pretraining Configs ===

@dataclass
class Exp_CameraTransformer_OXE_Magic_Soup_Plus_Minus(Exp_SigLIP_224px_Bridge):
...
class VLARegistry(Enum):
    ...
    # === CameraTransformer-VLA Pretraining Configs ===
    EXP_CAMERA_TRANSFORMER_OXE_MAGIC_SOUP_PLUS_MINUS = Exp_CameraTransformer_OXE_Magic_Soup_Plus_Minus
